...
export default async function Home({ searchParams }: PageProps) {
  ...
  try {
    courseData = await getCourseData(language as 'en' | 'bn')
  } catch (err) {
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <div className="bg-red-50 border border-red-200 rounded-lg p-8 max-w-md mx-auto">
            <h1 className="text-xl font-bold text-red-800 mb-2">Failed to Load Course</h1>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <div className="bg-gray-100 border border-gray-200 rounded-lg p-8 max-w-md mx-auto">
            <h1 className="text-xl font-bold text-gray-800 mb-2">No Course Data Available</h1>
            <p className="text-gray-600">Unable to load course information at this time.</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8 max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Right Column - Video Trailer & CTA */}
          <div className="lg:col-span-1 space-y-6">
            <VideoTrailer courseData={courseData} />
      ...
      <footer className="bg-gray-900 text-white py-12 mt-16">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="text-2xl font-bold tenms-primary mb-4">10 Minute School</div>
              <p className="text-gray-400 leading-relaxed">Bangladesh's largest online learning platform, helping millions of students achieve their goals.</p>
            </div>
            <div>
              <h4 className="font-bold mb-4">Courses</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">IELTS Preparation</a></li>
                <li><a href="#" className="hover:text-white transition-colors">Spoken English</a></li>
